...
import static github.yahuili1128.util.Parameters.BROKER_LIST;
import static github.yahuili1128.util.Parameters.TOPIC1;
...
public class KafkaProducerUtil {
	...
	public static void sendMessageToKafka(MockUpModel pojo) {
		...
		// 以json的方式发送消息
		ProducerRecord<String, String> record = new ProducerRecord<>(TOPIC1, null, null,
	...
	public static void sendMockUpModel() throws InterruptedException {
		...
		while (true) {
			...
			sendMessageToKafka(mockUpModel);
			Thread.sleep(1000);
			System.out.println("发送的是第---" + i + "---条数据");
			i++;
		}
